...
public class ProfileController {
	...
	@PostMapping("/upload")
	public String uploadProfile(@RequestParam("pid") int pid, @RequestParam("file") MultipartFile file, Model model) {
		try {
	...
	@GetMapping("/view")
	public ResponseEntity<byte[]> viewProfileImage(@RequestParam("profileId") int profileId) {
